...
alias mkdir='mkdir -p'                                                          # Make a new directory
alias rmdir='rm -rf'                                                            # Remove a directory
...
alias git-rebase-main='git co main && git pull && git co staging && git rebase main && git push -f'
...
alias dkclean='docker system prune -a --volumes'  # Delete all Docker containers, images, and volumes
...
alias crypto='cointop'                                                          # Shorthand for 'cointop' app
